...
let btn_btn_outline_success=document.querySelector('.search');
let d_flex=document.querySelector('.mysearch')
...
cardsSection.appendChild(newCards)
newCards.append(img, text, text2);
newCards.classList.add('section');
img.classList.add('img')
text.classList.add('h1')
text2.classList.add('p')
img.src=element.img;
text.innerHTML=element.txt1;
text2.innerHTML=element.txt2
});
